...
3. Карактеристике програмског језика Јава [презентација](/prezentacije-2020-21/OOP01-Karakteristike jezika Java.pdf){:target="_blank"}
    ...
    3.5. Јава алати за развој [филм](https://www.youtube.com/watch?v=dumWPA_5yhk&feature=youtu.be&t=36m55s){:target="_blank"} 
...
4. Објектно-оријентисана парадигма [презентација](/prezentacije-2020-21/OOP03-Objektno orjentisana paradigma.pdf){:target="_blank"}  
    ...
    4.1. Историјат и развој објектно-оријентисаног програмирања

    4.2. Основни појмови објектно-оријентисаног програмирања
    ...
    4.3. Напредни концепти објектно-оријентисаног програмирања
...
17. Елементи функционалног програмирања у Јави [презентација](/prezentacije-2020-21/OOP18-Lambda izrazi.pdf){:target="_blank"}

    17.1. Функцијски објекти у Јави

        17.1.1. Коришћење ламбда израза за функцијске објекте

        17.1.2. Запис ламбда израза

    17.2. Структура ламбда израза

        17.2.1. Интерфејс `Predicate`

        17.2.2. Интерфејси `Consumer`, `BiConsumer`

        17.2.3. Интерфејси `Function`, `IntFunction`, `BiFunction`

        17.2.4. Интерфејс `Collector`

        17.2.5. Интерфејси `UnaryOperator`, `BinaryOperator`

        17.4.6. Интерфејс `Supplier`

        17.4.7. Функцијски интерфејси, анотација `@Functional`

        17.4.8. Подразумевани методи интерфејса

    17.4. Токови


        17.4.2. Mетоди за креирање тока

        17.4.3. Интерфејси `Stream`, `IntStream`, `LongStream`, `DoubleStream`  

    17.5. Манипулације над токовима

        17.5.1. Филтрирање

        17.5.2. Мапирање и редукција

        17.5.3 Агрегација  

        17.5.4. Разлика између тока обраде и итератора  

18. Улаз и излаз [презентација](/prezentacije-2020-21/OOP17-Ulaz i izlaz, serijalizacija.pdf){:target="_blank"}

    18.1. Токови, читачи и писачи

        18.1.1. Улазни токови података

        18.1.2. Излазни токови података

        18.1.3. Читачи

        18.1.4. Писачи

    18.2. Уланчавање токова

    18.3. Датотеке и директоријуми

        18.3.1. Креирање `File` објекта

        18.3.2. Апсолутне и релативне путање

        18.3.3. Испитивање `File` објекта

    18.4. Класа `Scanner`

19. Серијализација и десеријализација

    19.1. Бинарна серијализација и десеријализација

        19.1.1. Серијализација, класа `ObjectOutputStream`

        19.1.2. Десеријализација, класа `ObjectInputStream`

        19.1.3. Напредна серијализација

    19.2. XML серијализација и десеријализација

20. Вишенитно прогамирање на ниском нивоу апстракције

    20.1. Конкурентност у рачунарству

        20.1.1. Паралелно и дистрибуисано процесирање
        
        20.1.2. Процес и нит

    20.2. Нити у Јави

        20.2.1. Креирање нити

        20.2.2. Прекидање нити

        20.2.3. Стање нити

        20.2.4. Приоритет нити

        20.2.5. Демон - нити

        20.2.6. Груписање нити  

    20.3. Синхронизација

        20.3.1. Проблем синхронизације

    20.4. Катанци, условни објекти и синхронизовани методи

        20.4.1. Катанци у Јави

        20.4.2 Условни објекти у Јави

        20.4.3. Синхронизовани објекти и методи

        20.4.4. Синхронизација приступа код колекција  

    20.5. Проблеми при извршавњу вишенитне апликације

        20.5.1. Смртоносно блокирање

        20.5.2. Живо блокирање
