package rs.ac.bg.matf.oop_p.p1804.oznaka;
...
public class Oznaka extends Application
{
	...
	private Button kreirajDugmeIspisi()
	{
		Button dugme = ButtonBuilder.create()
				...
				.onAction( new EventHandler<ActionEvent>()
				{
					...
					{
						ispisiPoruku( poMeniSePise, porukaVrednost.getText() );
