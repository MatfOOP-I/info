...
class FontDialog
	extends JDialog
	implements Constants, ActionListener, ChangeListener, ListSelectionListener
{
	...
	public FontDialog(SketchFrame window)
	{
		...
		JSplitPane splitPane =
			new JSplitPane(JSplitPane.VERTICAL_SPLIT, true, chooseFont, display);
		...
		JRadioButton italic =
			new JRadioButton("Italic", (fontStyle & Font.ITALIC) > 0);
	...
	public void valueChanged(ListSelectionEvent e)
	{
		...
		{
			font =
				new Font((String) fontList.getSelectedValue(), fontStyle, fontSize);
			fontDisplay.setFont(font);
			fontDisplay.repaint();
		}
	}
