...
public abstract class Element implements Serializable
{
	...
	public static class Line extends Element
	{
		...
		public Line(Point start, Point end, Color color)
		{
			...
			line =
				new Line2D.Double(
					origin,
					new Point(end.x - position.x, end.y - position.y));
		}
	...
	public static class Rectangle extends Element
	{
		...
		public Rectangle(Point start, Point end, Color color)
		{
			...
			rectangle =
				new Rectangle2D.Double(origin.x, origin.y, Math.abs(start.x - end.x),
				// Width
	...
	public static class Circle extends Element
	{
		...
		public Circle(Point center, Point circum, Color color)
		{
			...
			position = new Point(center.x - (int) radius, center.y - (int) radius);
				...
				circle =
					new Ellipse2D.Double(origin.x, origin.y, // Position - top-left
	...
	public static class Text extends Element
	{
			...
			java.awt.Rectangle bounds)
		{
			...
			this.text = text;
			this.bounds =
				new java.awt.Rectangle(origin.x, origin.y, bounds.width, bounds.height);
		}
