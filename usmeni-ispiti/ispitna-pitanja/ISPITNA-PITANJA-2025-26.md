# ООП - Испитна питања за усмене испите за академску 2025./26. годину код проф. Филиповића

[ООП](../../README.md) [Усмени испити](../README.md) [Испитна питања](README.md)

---

# Испитна питања у академској 2025/26 години
...
16. Улаз и излаз
    1. Токови, читачи и писачи. Примери
    1. Улазни токови података. Примери
    1. Излазни токови података. Примери
    1. Читачи. Примери
    1. Писачи. Примери
    1. Уланчавање токова. Примери
    1. Датотеке и директоријуми. Примери
    1. Класа Scanner и датотеке. Примери
